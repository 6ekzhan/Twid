...
class NavigationScreen extends StatefulWidget {
  ...
  double lng;
  final int i;
  final BitmapDescriptor iconn2;
  NavigationScreen(this.lat, this.lng, this.i, this.iconn2);
